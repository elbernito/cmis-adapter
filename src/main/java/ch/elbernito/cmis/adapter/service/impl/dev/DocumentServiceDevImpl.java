...
/**
 * DEV RestTemplate implementation of DocumentService.
 * Forwards all document-related requests to the configured DEV CMIS endpoint.
 */
@Slf4j
@Service
public class DocumentServiceDevImpl implements DocumentService {
    ...
    public DocumentServiceDevImpl(@Qualifier("devRestTemplate")RestTemplate restTemplate) {

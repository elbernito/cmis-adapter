...
/**
 * PROD RestTemplate implementation of AclService.
 * Forwards all ACL-related requests to the configured PROD CMIS endpoint.
 */
@Slf4j
@Service
public class AclServiceProdImpl implements AclService {
    ...
    public AclServiceProdImpl(@Qualifier("prodRestTemplate") RestTemplate restTemplate) {

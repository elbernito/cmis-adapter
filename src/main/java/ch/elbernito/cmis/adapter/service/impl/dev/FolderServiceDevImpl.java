...
/**
 * DEV RestTemplate implementation of FolderService.
 * Forwards all folder-related requests to the configured DEV CMIS endpoint.
 */
@Slf4j
@Service
public class FolderServiceDevImpl implements FolderService {
    ...
    public FolderServiceDevImpl(@Qualifier("devRestTemplate") RestTemplate restTemplate) {

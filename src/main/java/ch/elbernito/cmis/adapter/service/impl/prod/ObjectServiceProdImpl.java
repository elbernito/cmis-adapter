...
/**
 * PROD RestTemplate implementation of ObjectService.
 * Forwards all object-related requests to the configured PROD CMIS endpoint.
 */
@Slf4j
@Service
public class ObjectServiceProdImpl implements ObjectService {
    ...
    public ObjectServiceProdImpl(@Qualifier("prodRestTemplate") RestTemplate restTemplate) {

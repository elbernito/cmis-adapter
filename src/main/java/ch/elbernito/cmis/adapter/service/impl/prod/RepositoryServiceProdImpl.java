...
/**
 * PROD RestTemplate implementation of RepositoryService.
 */
@Slf4j
@Service
public class RepositoryServiceProdImpl implements RepositoryService {
    ...
    public RepositoryServiceProdImpl(@Qualifier("prodRestTemplate") RestTemplate restTemplate) {

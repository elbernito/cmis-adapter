...
/**
 * PROD RestTemplate implementation of MetadataService.
 * Forwards all metadata-related requests to the configured PROD CMIS endpoint.
 */
@Slf4j
@Service
public class MetadataServiceProdImpl implements MetadataService {
    ...
    public MetadataServiceProdImpl(@Qualifier("prodRestTemplate") RestTemplate restTemplate) {

...
/**
 * PROD RestTemplate implementation of RetentionService.
 * Forwards all retention-related requests to the configured PROD CMIS endpoint.
 */
@Slf4j
@Service
public class RetentionServiceProdImpl implements RetentionService {
    ...
    public RetentionServiceProdImpl(@Qualifier("prodRestTemplate") RestTemplate restTemplate) {

...
/**
 * Unit tests for AclServiceProdImpl.
 * Ensures correct REST calls are made for ACL operations in the PROD stack.
 */
class AclServiceProdImplTest {

    private RestTemplate restTemplate;
    private AclServiceProdImpl aclService;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        aclService = new AclServiceProdImpl(restTemplate);
        aclService.environmentTag = "PROD";
    }

...
/**
 * Unit tests for RepositoryServiceProdImpl.
 */
class RepositoryServiceProdImplTest {

    private RestTemplate restTemplate;
    private RepositoryServiceProdImpl service;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        service = new RepositoryServiceProdImpl(restTemplate);
        service.environmentTag = "PROD";
    }

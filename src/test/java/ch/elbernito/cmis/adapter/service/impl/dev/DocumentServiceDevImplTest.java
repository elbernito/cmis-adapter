...
/**
 * Unit tests for DocumentServiceDevImpl.
 * Verifies correct forwarding of requests and proper response mapping using a mocked RestTemplate.
 */
class DocumentServiceDevImplTest {

    private RestTemplate restTemplate;
    private DocumentServiceDevImpl documentService;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        documentService = new DocumentServiceDevImpl(restTemplate);
        // Simulate @Value injection for environmentTag
        documentService.environmentTag = "DEV";
    }

...
/**
 * Unit tests for AllowableActionsServiceProdImpl.
 * Ensures correct REST calls are made for allowable actions operations in the PROD stack.
 */
class AllowableActionsServiceProdImplTest {

    private RestTemplate restTemplate;
    private AllowableActionsServiceProdImpl allowableActionsService;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        allowableActionsService = new AllowableActionsServiceProdImpl(restTemplate);
        allowableActionsService.environmentTag = "PROD";
    }

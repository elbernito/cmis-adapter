...
/**
 * Unit tests for RetentionServiceProdImpl.
 * Ensures correct REST calls are made for retention operations in the PROD stack.
 */
class RetentionServiceProdImplTest {

    private RestTemplate restTemplate;
    private RetentionServiceProdImpl retentionService;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        retentionService = new RetentionServiceProdImpl(restTemplate);
        retentionService.environmentTag = "PROD";
    }

...
/**
 * Unit tests for MetadataServiceDevImpl.
 * Ensures correct REST calls are made for metadata operations in the DEV stack.
 */
class MetadataServiceDevImplTest {

    private RestTemplate restTemplate;
    private MetadataServiceDevImpl metadataService;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        metadataService = new MetadataServiceDevImpl(restTemplate);
        metadataService.environmentTag = "DEV";
    }

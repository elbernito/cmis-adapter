...
/**
 * Unit tests for ObjectServiceDevImpl.
 * Ensures correct REST calls are made for object operations in the DEV stack.
 */
class ObjectServiceDevImplTest {

    private RestTemplate restTemplate;
    private ObjectServiceDevImpl objectService;

    @BeforeEach
    void setUp() {
        restTemplate = mock(RestTemplate.class);
        objectService = new ObjectServiceDevImpl(restTemplate);
        objectService.environmentTag = "DEV";
    }
